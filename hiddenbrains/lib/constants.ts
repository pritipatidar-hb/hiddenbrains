...
export const SITE_NAME = "Corporate IT Services";
...
export const SERVICES = [
  ...
  },
  {
    ...
    title: "Hire Dedicated Developers",
    description:
      "Hidden Brains is one of the most trusted names in the tech industry to hire dedicated developers.",
    icon: "users",
    link: "/hire-dedicated-developers",
    iconBgColor: "bg-purple-50",
...
export const CLIENT_LOGOS = [
  ...
  "https://cdn-fdiob.nitrocdn.com/HbitivJBuLhibWNKENaXSPjRdSdrKXLC/assets/images/optimized/rev-748de10/www.hiddenbrains.co.uk/wp-content/uploads/2021/07/client-logo-08.webp",
];
